...
" Maintainer: machakann, cubicles
"------------------------------------------------------------
" Changes:
" - PreProc instances now use none instead of bold. When
"   using python it was highlighting keywords like 'from' and
"   i did not like how it looked
"
" - PreProc light color changed from kuwanomi to hiiro. This
"   makes a nice red instead of a loose purple for better
"   visibility
"
" - ColorColumn changed to make it a tad lighter. aokuchiba
"   impacted. Concealed, NonText seem like impacted variables
"------------------------------------------------------------
...
function! s:set() abort
  ...
  let aokuchiba      = {'gui': '#bdb470',   'cterm': '143'}
  ...
  if &background ==# 'light'
    ...
    let highlight_group.PreProc      = [hiiro,        none,        none,      none]
